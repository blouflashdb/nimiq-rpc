...
import { RPCData } from "../types/index.ts";
...
export class ValidatorClient {
   ...
   */
  public getSigningKey(options = DEFAULT_OPTIONS) {
   ...
   */
  public getVotingKey(options = DEFAULT_OPTIONS) {
   ...
   */
  public setAutomaticReactivation({ automaticReactivation }: SetAutomaticReactivationParams, options = DEFAULT_OPTIONS) {
   ...
   */
  public isElected(options = DEFAULT_OPTIONS) {
   ...
   */
  public isSynced(options = DEFAULT_OPTIONS) {
